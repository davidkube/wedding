...
export function DayPlan() {
  return (
    <Section id="day" ground="oat" className={cn("relative z-0", waveOverlapClass, waveOverlapPaddingClass)}>
      <Reveal>
        <Eyebrow sectionId="day">{day.eyebrow}</Eyebrow>
      </Reveal>

      <DrawLineFrame
        className="mt-[clamp(28px,4vw,48px)] grid grid-cols-[28px_1fr] gap-y-[clamp(18px,3vw,40px)] md:grid-cols-[1fr_40px_1fr]"
